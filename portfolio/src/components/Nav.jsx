    ...
    >
      ...
      <Link  className="nav-link resume">
        ...
        id="resume-button-1"
          ...
          target="_blank" bg="brand_secondary" color="#f8572f" _hover={{bg: "gray.200", color:"#e4512d" }} href="https://drive.google.com/file/d/1LGuYP9ZIPxCZXtgot-6fLWgx5YkIiowF/view?usp=sharing" download={true}
      ...
      <Box >
        ...
        >
          ...
          <Button  className="nav-link resume"
            ...
            border="1px"
            borderRadius="10px"
            href="https://drive.google.com/file/d/1LGuYP9ZIPxCZXtgot-6fLWgx5YkIiowF/view?usp=sharing"
            download={true}
            onClick={()=>handleClick(resume)}
            id="resume-button-1"
          >
